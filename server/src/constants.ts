...
export const DB_NAME = 'cyeg_weather_tracker_v3';
...
export const CHECKWX_API_KEY = '9b5eb6ee7a8d4cbe8877dfad37ab64c2';
...
export const MODELS: ModelConfig[] = [
    ...
    { id: 'ecmwf', provider: 'ecmwf', days: 15, label: 'IFS 0.25°', vars: FULL_VARS },
    { id: 'gfs', provider: 'gfs', days: 16, label: 'GFS 0.11°', vars: FULL_VARS },
    { id: 'gem', provider: 'gem', days: 10, label: 'GDPS 0.125°', vars: FULL_VARS },
    { id: 'dwd-icon', provider: 'dwd-icon', days: 7, label: 'ICON', vars: FULL_VARS },

    // --- Fragile / Limited Models ---
    { id: 'jma', provider: 'jma', days: 11, label: 'GSM 0.5°', vars: LIMITED_VARS },
    { id: 'cma', provider: 'cma', days: 10, label: 'GFS Grapes 0.125°', vars: LIMITED_VARS },
    { id: 'meteofrance', provider: 'meteofrance', days: 4, label: 'ARPEGE World 0.25°', vars: LIMITED_VARS },
    ...
    { id: 'gem-regional', provider: 'forecast', apiModel: 'gem_regional', days: 2, label: 'RDPS', vars: `${BASE_VARS},visibility` },

    // --- Additional Global Models ---
    // Fallback variants
    { id: 'ecmwf-04', provider: 'ecmwf', apiModel: 'ecmwf_ifs', days: 10, label: 'IFS 0.4°', vars: LIMITED_VARS },
...
export const VERIFICATION_VARIABLES = [
    ...
    { name: 'rain', obsKey: 'era_rain_amt', threshold: 0.5 },
    { name: 'snowfall', obsKey: 'era_snow_amt', threshold: 0.5 },
];
